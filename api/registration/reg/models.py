...
class Organization (models.Model):
    ...
    business_legal_name = models.CharField(max_length=1000, blank=True, null=True)      
    english_trade_name = models.CharField(max_length=1000, blank=True, null=True)
    french_trade_name = models.CharField(max_length=1000, blank=True, null=True)
    cra_business_number = models.CharField(max_length=1000, blank=True, null=True)
